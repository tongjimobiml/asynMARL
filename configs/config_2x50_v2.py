...
def get_config():
	...
	parser.add_argument("--algorithm_name", type=str,
						default='mappo', choices=["mappo", "ippo", "sp", "random", "mappo-nodag", "ippo-nodag"])
	parser.add_argument("--experiment_name", type=str, default="fixedlimit",
	...
	parser.add_argument("--network", type=str, default='2x50_v2', help="name of the road network")
	parser.add_argument("--num_agents", type=int, default=2, help="number of region agents")
	parser.add_argument("--network_path", type=str, default='environment/networks/2x50_v2',
						help="path of the network file")
	parser.add_argument("--sumo_config", type=str, default='environment/networks/2x50_v2/network.sumocfg',
						help="path of sumo config file")
	parser.add_argument("--network_file", type=str, default='environment/networks/2x50_v2/2x50_v2.net.xml')
	# parser.add_argument("--route_file", type=str, 
	# 			        default='environment/networks/2x50_v2/trips_biased_demand.xml',
	# 					help='environment/networks/2x50_v2/trips_biased_demand_fixedlimit.xml')
	parser.add_argument("--route_files", type=str,
						default='environment/networks/2x50_v2/trips_biased_demand.xml,environment/networks/2x50_v2/trips_uniform_demand.xml')
	parser.add_argument("--sumo_warnings", type=bool, default=True)
	...
	parser.add_argument("--fixed_demand", type=bool, default=False, help="Use fixed vehicle demand")
	...
	parser.add_argument("--use_dag_mask", type=bool, default=True)
	...
	parser.add_argument("--use_centralized_V", type=bool,
						default=True, help="Whether to use centralized V function")
	parser.add_argument("--use_new_centralized_V", action='store_false',
						default=True, help="Whether to use centralized V function")
