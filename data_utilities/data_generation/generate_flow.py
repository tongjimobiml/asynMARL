...
if __name__ == '__main__':
	...
	networkModel = DataUtils(configs['network'], '../../environment/networks/2x2x25')
	doc = Document()
	...
	with open('../../environment/networks/{}/trips_biased_demand_03.xml'.format(configs["network"]), 'w') as f:
